...
직접 개발하고 Cafe24에서 운영하는 개인 서비스와 실무에서 수행한 주요 프로젝트를 구분해 정리했습니다. 운영 서비스는 2026년 8월 16일(이후 추가된 5개 서비스는 9월 19일) 공개 URL의 응답과 화면을 직접 확인했으며, 실무 프로젝트는 원본 경력 자료에서 확인 가능한 범위만 포함했습니다.
